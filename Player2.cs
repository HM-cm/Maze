...
namespace JobApplicationProj3
{
    ...
    {
        public Player2(Canvas myCanvas):base(myCanvas)
        {
            for (int i = 0; i < 3; i++)
            {
                this.arrUp[i] = new BitmapImage(new Uri("ms-appx:///Assets/C2/CUp/CUp" + (i + 1) + ".png"));
                this.arrDown[i] = new BitmapImage(new Uri("ms-appx:///Assets/C2/CDown/CDown" + (i + 1) + ".png"));
                this.arrLeft[i] = new BitmapImage(new Uri("ms-appx:///Assets/C2/CLeft/CLeft" + (i + 1) + ".png"));
                this.arrRight[i] = new BitmapImage(new Uri("ms-appx:///Assets/C2/CRight/CRight" + (i + 1) + ".png"));
            }
