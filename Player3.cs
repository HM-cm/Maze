...
namespace JobApplicationProj3
{
    ...
    {
        public Player3(Canvas myCanvas) : base(myCanvas)
        {
            for (int i = 0; i < 3; i++)
            {
                this.arrUp[i] = new BitmapImage(new Uri("ms-appx:///Assets/C3/CUp/CUp" + (i + 1) + ".png"));
                this.arrDown[i] = new BitmapImage(new Uri("ms-appx:///Assets/C3/CDown/CDown" + (i + 1) + ".png"));
                this.arrLeft[i] = new BitmapImage(new Uri("ms-appx:///Assets/C3/CLeft/CLeft" + (i + 1) + ".png"));
                this.arrRight[i] = new BitmapImage(new Uri("ms-appx:///Assets/C3/CRight/CRight" + (i + 1) + ".png"));
            }
